#!/usr/bin/env python3
"""
Enhanced PPO Model Evaluation Script
Provides detailed performance metrics and statistics for PPO models
"""
...
class PPOEvaluator:
    def __init__(self, model_path="ppo_model_ep4000.pt", num_episodes=10):
    ...
    def run_single_episode(self, episode_num):
        ...
        # Use PPO server client with our specific model
        cmd = [sys.executable, "ppo_server_client.py", "--model", self.model_path]
        ...
        try:
            ...
            for line in iter(proc.stdout.readline, ''):
                ...
                if line:
                    ...
                    elif "GAME OVER" in line or "VICTORY" in line:
                        try:
    ...
    def print_detailed_results(self):
        ...
        print("\n" + "="*60)
        print("🏆 PPO MODEL EVALUATION RESULTS")
        print("="*60)
    ...
    def evaluate(self, show_viewer=False):
        ...
        print("🔍 PPO MODEL EVALUATION STARTING")
        print("="*50)
        print(f"Model: {self.model_path}")
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Evaluate PPO Pacman Model')
    parser.add_argument('--model', default='ppo_model_ep4000.pt', 
